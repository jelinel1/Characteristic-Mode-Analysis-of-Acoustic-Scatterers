...
%  part:           part of plotted current, char [1 x N],
%                    {'re', 'im', 'abs'}
%
% SYNTAX
%  results.plotCurrent(dataName, slotName, listPointName)
%  results.plotCurrent(dataName, slotName, listPointName, 're')
%
