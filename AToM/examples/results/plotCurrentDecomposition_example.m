%% plotCurrentDecomposition_example
% Example of current decomposition visualisation
%
...
% prepare session
fileName = 'plotCurrentDecomposition';
...
% settings: maxDegreeL:       maximal used degree of spherical waves
%           quadratureOrder:  defines number of integration points 
[decomposition, I] = results.calculateCurrentDecomposition(mesh, ...
    basisFcns, iVec, frequencyList, 'maxDegreeL', 10, ...
    'quadratureOrder', 1);

%% plot current decomposition
handles = results.plotCurrentDecomposition('frequency', frequencyList,...
    'decomposition', decomposition, 'indexMatrix', I)
