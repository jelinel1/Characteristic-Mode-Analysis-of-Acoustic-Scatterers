%% calculateEigennumber_example
% Example of eigennumber calculation
%
...
%% calculate eigenvalue from characteristic angle
eigennumber_new = results.calculateEigennumber(characteristicAngle);