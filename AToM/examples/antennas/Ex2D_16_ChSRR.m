%% Example generates chiral split-ring resonator
clc;
...
fullPath = fullfile('projects', [fileName '.atom']);
...
%% FIXME: I need to unify all objects... otherwise mesh is disconnected and MoM 
% fails.
...
% TODO: I would like to set up the parameters for all objects at once.
% atom.selectedProject.mesh.setLocalMeshDensity('OuterRingB', meshDensity);
% atom.selectedProject.mesh.setUseLocalMeshDensity( 'OuterRingB', true);
% 
% atom.selectedProject.mesh.setLocalMeshDensity('OuterRingT', meshDensity);
% atom.selectedProject.mesh.setUseLocalMeshDensity( 'OuterRingT', true);
% 
% atom.selectedProject.mesh.setLocalMeshDensity('RectangleLeft', meshDensity);
% atom.selectedProject.mesh.setUseLocalMeshDensity( 'RectangleLeft', true);
% 
% atom.selectedProject.mesh.setLocalMeshDensity('RectangleRight', meshDensity);
% atom.selectedProject.mesh.setUseLocalMeshDensity( 'RectangleRight', true);
