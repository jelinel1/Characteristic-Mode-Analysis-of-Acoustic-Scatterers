...
% This function evaluates auxiliary function beta, see Eq. (14) from
...
%
% OUTPUTS
%  beta: value of beta, double [Ntria x 1]
%
% SYNTAX
%
% S = models.solvers.singularities.triaRWG.s01( s1n, s1p, s2n, s2p,...
