...
% This function solves impedance matrix contributions zMatMk related to 1/R
% for places where quadrature points are overlapping.
% Contribution zMatMk does not contain anything related to 1/R.
%
%  INPUTS
