...
The code extensively uses functions from ATOM, see http://www.antennatoolbox.com/. The free version of ATOM can be found in the GIT folder and must be added to the MATLAB paths, including subdirectories.
